...
PORTFLAGS  := -p 3478:3478/udp -p 3480:3480/udp -p 3478:3478/tcp -p 3480:3480/tcp
...
test :
	docker run --rm -it $(NAMEFLAGS) $(RUNFLAGS) $(PORTFLAGS) $(MOUNTFLAGS) $(OTHERFLAGS) --entrypoint sh $(IMAGETAG) -ec 'turnserver -h;'
